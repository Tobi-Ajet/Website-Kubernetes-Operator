...
Built this project to learn and demonstrate how Kubernetes Operators work under the hood —
turning Kubernetes into a self-managing system that can deploy applications automatically.
